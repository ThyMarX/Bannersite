...
$args = array(
  'id_form'           => 'commentform',
  'id_submit'         => 'submit',
  'title_reply'       => __( 'Dialog og feedback om bannerne her.', 'salient' ),
  'title_reply_to'    => __( 'Svar på %s', 'salient' ),
  'cancel_reply_link' => __( 'Stop kommentar', 'salient' ),
  'label_submit'      => __( 'Send', 'salient' ),
  ...
  'logged_in_as' => '<p class="logged-in-as">' .
    sprintf(
    __( 'Logged ind som <a href="%1$s">%2$s</a>. <a href="%3$s" title="Log out of this account">Log ud?</a>', 'salient' ),
  ...
  'fields' => apply_filters( 'comment_form_default_fields', array(
    ...
    'author' =>
      ...
      '<label for="author">' . __( 'Navn og stilling', 'salient' ) .
      ' <span class="required">*</span></label> ' .
      '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) .
      '" size="30" /></div>',

    'email' =>
      '<div class="col span_4"><label for="email">' . __( 'E-mail', 'salient' ) .
      ' <span class="required">*</span></label>' .
