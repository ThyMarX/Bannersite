...
lib.ssMetadata = [
		{name:"930x180_atlas_P_", frames: [[0,0,930,180]]},
		{name:"930x180_atlas_P_2", frames: [[0,102,120,40],[0,0,160,100]]}
];
...
(lib.button = function() {
	this.initialize(ss["930x180_atlas_P_2"]);
	this.gotoAndStop(0);
...
(lib.Q8_LowRisQ_Privat160x600_Q8_LowRisQ_Privat = function() {
	this.initialize(ss["930x180_atlas_P_"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._930x180 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// price
	this.instance = new lib.Tween5("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-69,43.95,1.1042,1.1042);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:0.1,scaleX:1.5584,scaleY:1.5584,x:331,y:76},6).to({regX:0.1,regY:0.2,scaleX:1.3326,x:339.15,y:76.15},9).to({regX:0,regY:0.1,scaleX:1.5584,x:331,y:76},6).to({startPosition:0},21).to({startPosition:0},77).wait(1));

	// button
	this.instance_1 = new lib.Tween9("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(-70.1,129.05,1.03,1.03,0,0,0,-0.1,0.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(25).to({_off:false},0).to({x:505.9,y:133.05},10).to({startPosition:0},84).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(21).to({_off:false},0).to({x:512.55,y:49.3},6).to({startPosition:0},58).to({startPosition:0},34).wait(1));
...
p.nominalBounds = new cjs.Rectangle(237.5,87.6,692.5,92.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/930x180_atlas_P_.png", id:"930x180_atlas_P_"},
		{src:"images/930x180_atlas_P_2.png", id:"930x180_atlas_P_2"}
	],
	preloads: []
};
